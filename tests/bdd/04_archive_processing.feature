Feature: 04 Archive Processing
  ...
  Scenario: 04A - Valid 3MF Processing
     ...
     Then the output directory "valid_makerworld" should exist
     And the output directory "valid_makerworld" should contain "datapackage.json"
     And the output directory "valid_makerworld" should contain "valid_makerworld.3mf"
